    ...
    <div>
      ...
      <section className="relative bg-gray-900 text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-24 sm:px-6 lg:px-8 flex flex-col items-start">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Welcome to X-Store</h1>
          <p className="text-xl mb-8 max-w-xl">Discover our latest collection of premium products at unbeatable prices.</p>
          <Link
            href="/products"
