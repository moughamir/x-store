export default function CartItemList() {
  ...
  const cartItems = [
    { id: 1, productId: 1, name: 'Product 1', price: 19.99, quantity: 2, image: '/images/products/placeholder.jpg' },
    { id: 2, productId: 2, name: 'Product 2', price: 29.99, quantity: 1, image: '/images/products/placeholder.jpg' },
  ];
